...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/manyyeon", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// },
		{
			name: "LinkedIn",
			icon: "cib:linkedin",
			url: "https://www.linkedin.com/in/dayeon-yoo-71a705276/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/manyyeon",
		},
	],
};
